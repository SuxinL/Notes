                            ...
                            2. PROOF: critical thinking
                                ...
                                - ATOMIC
                                    ...
                                    2. EFFECT
                                        - CONDITIONS
                                            - ABOVE_FAIL
                                            - PAST_CASE: for things that happened in the pase. 
                                    3. CAUSE
                                        - CONDITIONS
                                            - ABOVE_FAIL
                ...
                - SYSTEM_SEARCH
                    1. BY_STRUCTURE
                        1. **TOP_DOWN**: search from top to a leaf
                            1. COMPONENT: SKIM all apparent components
                            2. SCAN: if #component <= 5, scan them
                            3. STRUCTURE: else check structure
                                1. TOC: if TOC, use it
                                2. SUMMARIZE: else, I summarize the structure     
                        2. TRY_OTHER_NODES: if not found at a leaf level, try other possible nodes recursively
                    2. BY_SEARCH_ENGINE
                        - CONDITIONS
                            - CASUAL_SEARCH
                            - FORMAL_SEARCH
