			...
			- [ ] act
				...
				- [ ] Q: what are goals of the *Other bookmarks* dir?
					- To avoid mess of the main dir.
						...
						- There are other sources of bookmarks like extensions or import from other platforms. We do not want these bookmarks mess our main bookmarks and the Other bookmarks folder is place for them.
				- [ ] Q: what are the options of import/export bookmarks?
				- [ ] Q: what is the *mobile bookmarks* dir?
			- [ ] test
	
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MjA5MDYxNDRdfQ==
-->